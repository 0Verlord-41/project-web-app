...
var displayMap = function displayMap(locations) {
  ...
  new mapboxgl.Marker({
    element: el,
    anchor: 'bottom'
  }).setLngLat(locations[0].coordinates).addTo(map);
...
var findLocation = function findLocation(input) {
  try {
...
var signitup = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('provide with correct details', 'try again');
  ...
  return function signitup(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();

exports.signitup = signitup;
...
var stripe = Stripe('pk_test_51K9VKvSDT08YQIF8dvGpzu0vTtgehZj45oEWfFO3vztfX6qvVW1ADQLfrqGxIIdJKGWYFKA0tYSFuFJFt4FIoF4Y00EVLrZVLG');

var bookRest = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(restid) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(restid));
  ...
  return function bookRest(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookRest = bookRest;
...
var formbtn = document.querySelector('.form--signup');
var bookBtn = document.getElementById('book-rest'); // DELEGATION
...
if (formbtn) {
  formbtn.addEventListener('submit', function (e) {
    ...
    (0, _signup.signitup)(name, email, password, passwordConfirm);
  });
}
